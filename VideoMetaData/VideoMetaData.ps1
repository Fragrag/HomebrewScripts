...
# Make sure running scripts is allowed in Powershell
# To set this, run Powershell as admin and execute this command: set-executionpolicy remotesigned
...
$videoMetadata = Get-FileMetaData -folder (Get-childitem \\haryonas\media\video\Movies\ -Recurse -Directory).FullName
